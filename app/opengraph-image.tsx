...
export const alt = "Kick Bot — Better team rituals, right inside Slack";
  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", background: "#fffdf8", color: "#15162a", padding: "72px 86px", fontFamily: "Arial, sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", width: 760 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", marginTop: 58, fontSize: 66, lineHeight: 1.05, fontWeight: 800, letterSpacing: -3 }}><span>Better team rituals.</span><span style={{ color: "#f36b2b" }}>Right inside Slack.</span></div>
