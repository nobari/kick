  ...
  return (
    <main id="main-content" className="legal-main section-shell">
      ...
      <div className="support-grid">
        <section className="support-card"><h2>Command help</h2><p>Follow the <a href="/get-started">getting-started guide</a> for your first update. Add <code>-h</code> to any Kick command—for example, <code>/sync -h</code>—to see current options inside Slack.</p></section>
