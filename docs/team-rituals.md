...
- Each tick handles up to ten due configurations and 25 delivery jobs, with a time budget. Monitor backlog as workspace count grows. Scale workers before high-volume rollout. Due jobs/configurations and retention lookups use Postgres indexes.
